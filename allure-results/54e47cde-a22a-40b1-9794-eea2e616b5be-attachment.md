...
```
Error: locator.textContent: Error: strict mode violation: locator('#customers td:right-of(td:text("Helen Bennett"))') resolved to 6 elements:
...
```ts
  ...
  10 | 
> 11 | const row = await page.locator('#customers td:right-of(td:text("Helen Bennett"))').textContent();
     |                                                                                    ^ Error: locator.textContent: Error: strict mode violation: locator('#customers td:right-of(td:text("Helen Bennett"))') resolved to 6 elements:
