...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    10 × locator resolved to <html lang="en" data-theme="light">…</html>
...
```ts
  ...
  10 |     await page.getByRole('button', { name: 'Login to Practice Account' }).click();
> 11 |     expect(page).toHaveURL('https://app.thetestingacademy.com/playwright/multiple_element_filter?email=&password=#login-success');
     |                  ^ Error: expect(page).toHaveURL(expected) failed
