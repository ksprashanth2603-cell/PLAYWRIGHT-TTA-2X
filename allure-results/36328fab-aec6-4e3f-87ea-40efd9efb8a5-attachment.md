...
- Name: 20_Assignment_Practice\01_Login.spec.ts >> Toverify Login Page of Parctice assigment
- Location: tests\20_Assignment_Practice\01_Login.spec.ts:3:5
...
Expected: "https://app.thetestingacademy.com/playwright/multiple_element_filter?email=&password=#login-success"
Received: "https://app.thetestingacademy.com/playwright/multiple_element_filter?email=student%40gmail.com&password=student&remember=yes#login-success"

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    11 × locator resolved to <html lang="en" data-theme="light">…</html>
       - unexpected value "https://app.thetestingacademy.com/playwright/multiple_element_filter?email=student%40gmail.com&password=student&remember=yes#login-success"
  - Test ended.
...
```ts
  ...
  2  | 
  3  | test('Toverify Login Page of Parctice assigment', async ({page})=>
  4  | {
  5  |     await page.goto('https://app.thetestingacademy.com/playwright/multiple_element_filter');
  6  |     await page.getByPlaceholder('student@thetestingacademy.com').fill('student@gmail.com');
  7  |     await page.getByPlaceholder('Password').fill('student');
  8  |     await page.getByRole('checkbox', { name: 'Remember Me' }).check();
  9  |     await page.getByRole('button', { name: 'Login to Practice Account' }).click();
> 10 |     expect(page).toHaveURL('https://app.thetestingacademy.com/playwright/multiple_element_filter?email=&password=#login-success');
     |                  ^ Error: expect(page).toHaveURL(expected) failed
